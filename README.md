...
Étudiant en Bachelor IT (Systèmes et Réseaux) à La Plateforme (Marseille) / Cybersup (Paris). Après un parcours en Électrotechnique, j'ai pivoté vers l'infrastructure et la sécurité avec un objectif précis : À terme, mon objectif est d'obtenir un Master afin de me spécialiser en tant qu'Analyste SOC.

Je cherche actuellement une alternance en administration systèmes, réseaux ou support IT (Marseille, Paris ou Télétravail).
...
#### Labs & Compétitions
* **Hack'In 2026 :** Classé dans le TOP 12 (focus sur les catégories Forensic et OSINT).
* **Root-Me PRO :** Entraînement continu sur le parcours Analyste SOC Niveau 1 (traitement d'incidents, analyse de logs).
* **Certifications :** Préparation de la certification RHCSA (Red Hat Certified System Administrator, examen prévu pour juillet 2026). Titulaire du MOOC RGPD de la CNIL.
